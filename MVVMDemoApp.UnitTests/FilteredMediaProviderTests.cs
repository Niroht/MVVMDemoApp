...
{
    [TestFixture]
    public class FilteredMediaProviderTests
    {
        [Test]
        ...
        private class TestContext
        {
            public TestContext()
            {
                ...
                TelevisionSeriesProviderMock = new Mock<ITelevisionSeriesProvider>();

                Sut = new FilteredMediaProvider(FilmProviderMock.Object, TelevisionSeriesProviderMock.Object);
            }

            public FilteredMediaProvider Sut { get; }

            public Mock<IFilmProvider> FilmProviderMock { get; }

            public Mock<ITelevisionSeriesProvider> TelevisionSeriesProviderMock { get; }
        }
    }
}
